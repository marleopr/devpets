...
import cats from "../assets/catBook.png"
import styled from "styled-components"
import StarRatingCats from "../components/StarRatingCats"
    ...
    const handleDog = async () => {
        ...
        try {
            const res = await axios.get(
                `https://api.api-ninjas.com/v1/cats?name=${debouncedNome}`, {
                headers: {
        ...
        <Main>
            ...
            <div style={{ color: 'white' }} >
                {loading ? (
                    ...
                    data && data ? (
                        <StarRatingCats data={data} />
                    ) : (
                        <img style={{ marginTop: '10px', width: '40rem' }} src={cats} alt="cats" />
                    )
                )}
            </div>
        </Main>
